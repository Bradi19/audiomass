...
*/
        ...
        value: function clearWaveForEntry(entry) {
            ...
            entry.waveCtx.fillStyle = "#F0F1F4";
           ...
           // }
            ...
            else
            {
                if(this.params.waveColor.length > 0){
                    ...
                    gradient.addColorStop(.5, this.params.waveColor[1]);
                    gradient.addColorStop(1, this.params.waveColor[2]);
...
var WaveSurfer = function (_util$Observer) {
    ...
    function WaveSurfer(params) {
        ...
        _this.defaultParams = {
            ...
            skipLength: 2,
            splitChannels: false,
            waveColor: ['#6FB9D9', '#2F6A99', '#1F4563'],
    ...
    },
    {
        ...
        value: function setHeight(height) {
            ...
            let left = this.container.parentNode.getElementsByClassName('pk_pan_left')[0],
            right = this.container.parentNode.getElementsByClassName('pk_pan_right')[0], all = this.container.parentNode.getElementsByClassName('pk_panner')[0];
            left.style.height = height/2.4+ "px"
            right.style.height = height/2.4 + "px"
